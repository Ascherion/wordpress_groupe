<?php
    function headStyle(){
        wp_enqueue_style( 'bootstrap', '//maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css', null, true);
        wp_enqueue_style( 'style', get_stylesheet_directory_uri() . '../css/style.css', null, true );

}add_action( 'wp_enqueue_style', 'headStyle' );
    ...
    }add_action( 'wp_enqueue_script', 'headScript' );
?>